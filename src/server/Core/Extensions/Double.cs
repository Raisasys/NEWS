...
partial class XExtensions
{
    ...
    /// <param name="multiplyBy100">Determines whether output is divided by 100 or not.</param>
    /// <param name="roundTo">Determines whether output is rounded or not.</param>
    public static decimal AsPercentageOf(this decimal @this, decimal total, bool multiplyBy100 = true,
        int? roundTo = null)
    {
        var pc = @this / total;
    ...
    public static float LimitWithin(this float @this, float minValue, float maxValue) =>
        @this.LimitMin(minValue).LimitMax(maxValue);
    ...
    /// <param name="minValue">Determines the minimum value for comparing.</param>
    /// <param name="maxValue">Determines the maximum value for comparing.</param>
    public static double LimitWithin(this double @this, double minValue, double maxValue) =>
        @this.LimitMin(minValue).LimitMax(maxValue);
    ...
    /// <param name="minValue">Determines the minimum value for comparing.</param>
    /// <param name="maxValue">Determines the maximum value for comparing.</param>
    public static int LimitWithin(this int @this, int minValue, int maxValue) =>
        @this.LimitMin(minValue).LimitMax(maxValue);
    ...
    /// <param name="minValue">Determines the minimum value for comparing.</param>
    /// <param name="maxValue">Determines the maximum value for comparing.</param>
    public static long LimitWithin(this long @this, long minValue, long maxValue) =>
        @this.LimitMin(minValue).LimitMax(maxValue);
    ...
    /// <param name="minValue">Determines the minimum value for comparing.</param>
    /// <param name="maxValue">Determines the maximum value for comparing.</param>
    public static decimal LimitWithin(this decimal @this, decimal minValue, decimal maxValue) =>
        @this.LimitMin(minValue).LimitMax(maxValue);
