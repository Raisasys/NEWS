...
partial class XExtensions
{
    ...
    public static Task<IOrderedEnumerable<T>> ThenBy<T, TKey>(this Task<IOrderedEnumerable<T>> @this,
        Func<T, TKey> keySelector)
        => @this.Get(x => x.ThenBy(keySelector));

    public static Task<IOrderedEnumerable<T>> ThenByDescending<T, TKey>(this Task<IOrderedEnumerable<T>> @this,
        Func<T, TKey> keySelector)
