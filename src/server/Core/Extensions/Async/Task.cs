...
partial class XExtensions
{
    ...
    public static async Task WithTimeout(this Task @this, TimeSpan timeout, Action success = null,
    ...
    public static async Task<T> WithTimeout<T>(this Task<T> @this, TimeSpan timeout, Action success = null,
        Func<T> timeoutAction = null)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static async Task<TResult> Get<TSource, TResult>(this Task<TSource> @this,
        Func<TSource, Task<TResult>> expression)
    {
    ...
    public static async Task<TResult> ResultOrDefault<TResult>(this Task<TResult> @this)
    {
        try
        {
            return await @this.ConfigureAwait(continueOnCapturedContext: false);
        }
        catch
        {
    ...
    /// </summary>
    public static Task<T> FastestOrDefault<T>(this IEnumerable<Task<T>> @this, Func<T, bool> resultValidator,
        TimeSpan timeout)
    {
