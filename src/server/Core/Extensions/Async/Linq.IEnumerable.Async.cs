...
partial class XExtensions
{
    ...
    public static Task<IEnumerable<TResult>> SelectManyAsync<TSource, TResult>(
        ...
        => @this.OrEmpty().SelectMany(func).AwaitAll();

    public static Task<IEnumerable<T>> Except<T>(this IEnumerable<T> @this, Func<T, Task<bool>> criteria)
        => @this.OrEmpty().Where(i => criteria(i).ContinueWith(x => !x.GetAlreadyCompletedResult()));
    ...
    public static async Task<IEnumerable<T>> Concat<T>(
        this IEnumerable<T> @this, Task<IEnumerable<T>> second) =>
        @this.Concat((await second.ConfigureAwait(false)).OrEmpty());
    ...
    public static async Task<IEnumerable<T>> Intersect<T>(
        this IEnumerable<T> @this, Task<IEnumerable<T>> second) =>
        @this.Intersect((await second.ConfigureAwait(false)).OrEmpty());
    ...
    public static async Task<IEnumerable<TResult>> Zip<TSource, TSecond, TResult>(this IEnumerable<TSource> @this,
        Task<IEnumerable<TSecond>> second, Func<TSource, TSecond, TResult> func) =>
        @this.Zip((await second).OrEmpty(), func);

    public static Task<IEnumerable<TResult>> Zip<TSource, TSecond, TResult>(this IEnumerable<TSource> @this,
        IEnumerable<Task<TSecond>> second, Func<TSource, TSecond, TResult> func) => @this.Zip(second.AwaitAll(), func);

    public static Task<IEnumerable<TResult>> Zip<TSource, TSecond, TResult>(this IEnumerable<TSource> @this,
        Task<IEnumerable<TSecond>> second, Func<TSource, TSecond, Task<TResult>> func)
    {
    ...
    public static async Task<TResult> Max<TSource, TResult>(this IEnumerable<TSource> @this,
