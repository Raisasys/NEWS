...
partial class XExtensions
{
    ...
    /// </summary>
    /// <param name="other">Is a date which is compared with this value.</param>
    public static bool IsInSameMonth(this DateTime @this, DateTime other) =>
    ...
    /// </summary>
    public static DateTime GetBeginningOfWeek(this DateTime @this) =>
        @this.Date.GetLast(DayOfWeek.Monday, skipToday: false);
    ...
    /// </summary>
    public static string ToSmallTime(this DateTime date) =>
        date.ToString("h:mm").TrimEnd(":00") + date.ToString("tt").ToLower();
    ...
    /// </summary>
    /// <param name="longForm">determines whether the abstractions of Hours, Minutes or Seconds are shown</param>
    public static string ToTimeDifferenceString(this DateTime @this, bool longForm) =>
        ToTimeDifferenceString(@this, 2, longForm);

    /// <summary>
    /// Gets the difference day and time between this date and now.
    /// </summary>
    /// <param name="precisionParts">Determines the number of output parts</param>
    public static string ToTimeDifferenceString(this DateTime @this, int precisionParts) =>
        ToTimeDifferenceString(@this, precisionParts, longForm: true);
    ...
    public static DateTime AddWeeks(this DateTime @this, int numberOfWeeks) =>
        @this.AddDays(WEEK_DAYS_COUNT * numberOfWeeks);
