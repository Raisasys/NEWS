...
partial class XExtensions
{
    ...
    /// </summary>
    public static Dictionary<string, TValue> AddFromProperties<TValue>(this Dictionary<string, TValue> @this,
        object data)
    {
        if (data == null)
    ...
    public static ConcurrentDictionary<TKey, TValue> Concurrent<TKey, TValue>(this Dictionary<TKey, TValue> @this) =>
        new ConcurrentDictionary<TKey, TValue>(@this);
}