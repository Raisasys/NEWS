...
partial class XExtensions
{
    ...
    public static string FormatWith(this string @this, object arg, params object[] additionalArgs)
    {
        ...
        {
            throw new FormatException("Cannot format the string '{0}' with the specified arguments.".FormatWith(@this),
                ex);
        }
    }
    ...
    public static string Remove(this string @this, string firstSubstringsToRemove,
        params string[] otherSubstringsToRemove) =>
    ...
    /// <param name="otherSubstringsToRemove">A list of Strings which are removed.</param>
    /// <param name="caseSensitive">Determined whether case sensitive is important or not.</param>
    public static string Remove(this string @this, string firstSubstringsToRemove, bool caseSensitive,
        params string[] otherSubstringsToRemove) =>
    ...
    /// </summary>
    public static IEnumerable<string> ToLower(this IEnumerable<string> @this) =>
        @this.ExceptNull().Select(i => i.ToLower());

    /// <summary>
    /// Returns the all-upper-case version of this list.
    /// </summary>
    public static IEnumerable<string> ToUpper(this IEnumerable<string> @this) =>
        @this.ExceptNull().Select(i => i.ToUpper());
    ...
    public static string TrimBefore(this string @this, string search, bool trimPhrase = false,
    ...
    public static string EnsureStartsWith(this string @this, string expression, bool caseSensitive = true)
    {
        ...
        if (@this.StartsWith(expression,
                caseSensitive ? StringComparison.Ordinal : StringComparison.OrdinalIgnoreCase)) return @this;
    ...
    {
        return new[] { "http://", "https://", "//" }.Any(x =>
            @this.OrEmpty().StartsWith(x, StringComparison.OrdinalIgnoreCase));
    }
    ...
    /// </summary>
    public static string FromGZippedBase64(this string base64) => base64.IsEmpty()
        ? string.Empty
        : base64.ToBytesFromBase64().UnGZip().ToString(Encoding.UTF8);
}